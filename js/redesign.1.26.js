...
var x = $(id);
x.innerHTML = '<div id="showprogress"><table border="0" align="center"><tr><td style="text-align:right;padding-top:50px;padding-bottom:0px;">Loading...</td><td style="text-align:left;padding-top:50px; padding-bottom:0px;"><img src="http://storage.googleapis.com/mvassets/images/community_images/smallspinner.gif"></td></tr></table></div>';
}
