Ext.onReady(function(){
    ...
    var store = new Ext.data.Store({
        ...
        proxy: new Ext.data.ScriptTagProxy({
			url: '../active-investor/closepositionsdata.htm'
        }),
        ...
        reader: new Ext.data.JsonReader({
            ...
            fields: [
                'Companyname','creation_date','unit_price','Date Opened','Purchase Price','# of Shares','Purchase Amount','Sale Proceeds','GainLoss','GainLosspercent'
            ]
        }),
    ...
    var grid = new Ext.grid.GridPanel({
        el:'topic-grid',
        height:405,
        title:"FlexFolio's - Close Positions",
        store: store,
        cm: cm,
