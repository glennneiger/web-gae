    ...
    if (firing === true) {
      $(this).scroll(function() {
        ...
        if (is_scrollable && (options.fireOnce == false || (options.fireOnce == true && fired != true))) {
          ...
          $(options.insertAfter).after("<li class=\"ss\" id=\"endless_scroll_loader\">" + options.loader + "</li>");

          data = typeof options.data == 'function' ? options.data.apply(this, [fireSequence]) : options.data;

          if (data !== false) {
            $(options.insertAfter).after("<li class=\"hh\" id=\"endless_scroll_data\">" + data + "</li>");
            $("#endless_scroll_data").hide().fadeIn();
            $("#endless_scroll_data").removeAttr("id");

            options.callback.apply(this, [fireSequence]);

            if (options.fireDelay !== false || options.fireDelay !== 0) {
              $("body").after("<li class=\"jsnjd\" id=\"endless_scroll_marker\"></li>");
