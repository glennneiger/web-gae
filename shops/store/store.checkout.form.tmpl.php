...
<?if($error){?>
<TR>
<TD colspan=6 class="padding" style="font-size:11px" align=center>
	<table width=50%>
	<TR>
	<TD class="error">
		We encountered an error while processing your order:<br>
		<li style="font-weight:bold" class="error"><?=strip($error)?></li>
	</TD>
	</TR>
	</table>
</TD>
...
<!-- ========================= billing =================== -->
<table>
<TR><TD colspan=2><b>Billing Information</b><br>
 <span class="error small">Billing info. must match bank info on your account</span></TD></TR>
<TR>
...
<TR>
<TD colspan=2>*Address Line 1:<br><?input_text("ord[b_address]",$ord[b_address],45,255)?></TD>
</TR>
<TR>
<TD colspan=2>Address Line 2:<br><?input_text("ord[b_address2]",$ord[b_address2],45,255)?></TD>
</TR>
<TR>
<TD>*City: <br><?input_text("ord[b_city]",$ord[b_city])?></TD>
<TD nowrap><span style="width:120px">*State</span> *Zip Code<br>
	<select name="ord[b_state]" style="width:120px" onchange="selectCountry('b')">
...
<TD colspan=2>*Country<br>
	<select name="ord[b_country]" style="width:200px" onchange="deselectState('b')">
...
<TR>
<TD colspan=2>*Email Address: &nbsp;<span class="error small">Valid email address required for order confirmation</span><br><?input_email("ord[b_email]",$ord[b_email],45,255)?></TD>
</TR>
</table>
...
<table>
<TR><TD colspan=2><b>Shipping Information</b>  &nbsp;
...
<TD nowrap><span style="width:120px">*State</span> *Zip Code<br>
	<select name="ord[s_state]" style="width:120px" onchange="selectCountry('s')">
	<option value="">-State-</option>
 ...
 <TR>
<TD colspan=2>*Country<br>
	<select name="ord[s_country]" style="width:200px" onchange="deselectState('s')">
...
<TD class="slimpadding">
	...
	<!-- ================== payment ======================= -->
 	<table>
	<TR>
	<TD colspan=2><b>Payment Options</b></TD>
	</TR>
	<TR>
	<TD colspan=2>*Credit Card Type<br>
		<select name="ord[cc_type]"><?selectHash($STORE_CC_TYPES,$ord[cc_type])?></select>
	</TD>
	</tr>
	<TR>
	...
	<TD>&nbsp;*Security Code<br>&nbsp;
	<?input_intonly("ord[cc_cvv2]",$ord[cc_cvv2],4,4)?> <a href="javascript:;" class="small" onclick="openCVV2()">What's this?</a>
	</TD>
	</TR>
	</table> 
...
<TR>
<TD colspan=6 class="slimpadding">&nbsp;</TD>
</tr>


<TR>
<TD colspan=2 align=right height=30 class="slimpadding">
	<b>*</b><span class="error">Required Field</span>
&nbsp;&nbsp;
	<input class=button type="button" value="continue shopping" onclick="continueShopping()" onmouseover="bOn(this)" onmouseout="bOff(this)">
	<input class="button" type="button" value="confirm order" onclick="validateForm()" onmouseover="bOn(this)" onmouseout="bOff(this)"> 
</TD>
</TR>
...
<b>Express Delivery Information </b><br>
