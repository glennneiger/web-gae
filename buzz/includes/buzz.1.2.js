...
function jumpRequest(pars) {
	var url = '_content.php';
	var myAjax4 = new Ajax.Request(url, {method: 'post', parameters: pars, onLoading:loading('shwprogressdata'), onComplete:finishJump});
}
function loading(id){
	$(id).innerHTML='<span style="color:#565959;font-size:11px;padding-left:3px;padding-bottom:1px;  background-color:#ffffcc;position:absolute;z-index:1000;">Loading....</span>'; 	 
