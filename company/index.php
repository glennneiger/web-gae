...
$title= "EVENTS";
$pageName = 17; //PAGE NAME 'university' didn't work
...
?>
		...
		<td width="616">
		  <div id="fixed-center-area-main">
		  	<div style="background: #FFF url(../images/university_header2.gif) top left no-repeat;">
				   	<div id="university-date">
						<img src="../images/1x52.gif" alt="" /><br>
						<h3><?= displayDate() ?></h3>					
					</div>
			</div>
			<div id="home-news-content"> <!-- style="background: #FFF url(../images/university_header_btm.gif) top left no-repeat;" -->
			<div class="space-right">
			 ...
			 <table id="all-left-news" cellpadding="0" cellspacing="0"><tr>
				...
				<p class="top-adv">&nbsp;</p>
				   <div id="frame-bg">
				     <img src="../images/comic_300x250.gif" width="301" height="251" alt="" /><br />
