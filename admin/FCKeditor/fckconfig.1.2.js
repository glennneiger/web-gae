...
FCKConfig.ToolbarSets["Default"] = [
	...
	['Bold','Italic','Underline','StrikeThrough','-','Subscript','Superscript','-','ajaxAutoSave'],
...
FCKConfig.ToolbarSets["Basic"] = [
  ...
  ['Image', 'Flash','YouTube', 'Table','Rule','SpecialChar','PageBreak','UniversalKey'],
...
FCKConfig.ToolbarSets["ImageLink"] = [
	
	['Image','Link','Unlink','Source','ajaxAutoSave']
]
...
FCKConfig.LinkBrowserURL = FCKConfig.BasePath + 'filemanager/browser/default/browser.html?Type=File&Connector=connectors/php/connector.php' ;
...
FCKConfig.LinkUploadURL = FCKConfig.BasePath + 'filemanager/upload/php/upload.php?Type=File' ;
...
// URL to post to
FCKConfig.ajaxAutoSaveTargetUrl = '/admin/FCKeditor/editor/plugins/ajaxAutoSave/saveAdapter/saveAdapter.php' ;
