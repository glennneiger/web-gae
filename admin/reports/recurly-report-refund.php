...
AND date <= '2012-07-31' and status='success' and action='refund' ";
        ...
        // htmlprint_r($row);
           $sql="select fname,lname,email,via_id from subscription where id='".$row['subscription_id']."'";
            ...
            $newdate = date ( "Y-m-d" , $newdate );
             $sql="select id,recurly_plan_code,recurly_plan_name,recurly_total_amount_in_cents,recurly_canceled_at,
...
csv_header("recurly-subscription-refund.csv");
$datestr="%m/%d/%Y";
data2csv($arr);
