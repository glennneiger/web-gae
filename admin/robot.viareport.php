...
AND creation_date <= '2012-05-31' AND payment_clear_status = '3' AND base_amount>0 limit ".$offset.",1000";
...
csv_header("VIA-active-subscription-05/01/2011-05-31-2012.xls");
$datestr="%m/%d/%Y";
data2csv($arr);
