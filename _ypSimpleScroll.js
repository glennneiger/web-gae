...
function ypSimpleScroll(id, left, top, width, height, speed, contentWidth, initLeft, initTop)
{
	...
	if (y.ie || y.ns4 || y.dom) {
		...
		d.write('#' + this.id + 'Container { left:' + left + 'px; top:' + top + 'px; width:' + width + 'px; height:' + height + 'px; clip:rect(0 ' + width + ' ' + height + ' 0); overflow:hidden; z-index:100}')
		d.write('#' + this.id + 'Container, #' + this.id + 'Content { position:absolute; };z-index:100')
