...
class MCAPI {
    ...
    var $api_endpoint = 'http://us5.api.mailchimp.com/1.3/?output=php';
    ...
    function MCAPI($apikey, $secure=false) {
     ...
     //   $this->apiUrl = parse_url("http://api.mailchimp.com/" . $this->version . "/?output=php");
	    ...
	    if (strstr($this->api_key,"-")){
            ...
            if (!$dc) 
            {
             	$this->api_endpoint = str_replace('us1', $dc, $this->api_endpoint);
            }
        }
    }
    ...
    */
    ...
    function callServer($method,$params)
    {
        ...
        $url = $this->api_endpoint."&method=".$method."&apikey=".$this->api_key;
    ...
    function callServer_old($method, $params) {
	    $dc = "us1";
	    if (strstr($this->api_key,"-")){
        	list($key, $dc) = explode("-",$this->api_key,2);
            if (!$dc) $dc = "us1";
