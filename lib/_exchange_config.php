...
$page_config['login']['URL']=$HTPFX.$HTHOST."/subscription/register/login.htm";
...
$page_config['blog']['URL']=$HTPFX.$HTHOST."/community/blog.htm";
...
$page_config['register_manage']['URL']=$HTPFX.$HTHOST."/subscription/register/";
$page_config['register_new']['URL']=$HTPFX.$HTHOST."/subscription/register/";
$page_config['buzz']['URL']=$HTPFX.$HTHOST."/buzz/print.php";
$page_config['friends']['URL']=$HTPFX.$HTHOST."/community/friends.htm";
$page_config['emailsetting']['URL']=$HTPFX.$HTHOST."/subscription/register/controlPanel.htm";
...
// for dailyFeed email alert
$DAILYFEED_EML_TMPL=$HTPFX.$HTADMINHOST."/emails/_eml_daily_feed_update.htm";
