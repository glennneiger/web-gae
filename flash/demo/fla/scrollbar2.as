...
onClipEvent (load) {
	...
	if(direction == 1){
		...
		frameH = _parent.frame._width;
		trace("frame width is " + _parent.frame._width);
	}
	...
	function getInfo(){
		if(direction == 1){
			...
			pageH = _parent._parent.babyStoryHeight * 14;
			//trace(pageH);
		}else{
			pageH = _parent.babyThumbNav._width;
		}
	...
	function apply(){
		if(direction == 1){
			...
			_parent.babyThumbNav._x = pageP -70;
		}
		Thumb._y = yposB
